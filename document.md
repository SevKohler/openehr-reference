...
- **`LINK` deprecation**: `DV_REFERENCE` covers the clinical use case. Should `LINK` be deprecated?

- **`OBJECT_REF` / `PARTY_REF`**: relationship to `DV_REFERENCE.external_ref` is unresolved and needs discussion.
